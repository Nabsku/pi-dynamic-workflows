...
- **Delegated backend:** read [pi-subagents backend](references/pi-subagents-backend.md) before setting `backend: "pi-subagents"`; native execution is the default and delegation is an explicit fail-closed opt-in.
