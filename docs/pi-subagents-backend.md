...
```bash
pi install git:github.com/Nabsku/pi-dynamic-workflows@b69cd0af014c3a86592bc35ac8fb4228b56af837
...
| --- | --- | --- |
| `Nabsku/pi-dynamic-workflows@b69cd0af014c3a86592bc35ac8fb4228b56af837` | `Nabsku/pi-subagents@b77781ea926203b32af8fad439432e5cef2aae5f` | Tested experimental provider discovery, delegation v1, request-scoped lifecycle semantics, and truthful delegated model diagnostics |
...
git -C "$VERIFY_DIR" checkout --detach b69cd0af014c3a86592bc35ac8fb4228b56af837
cd "$VERIFY_DIR"
npm ci
```
